...
#################################################################################
{
    ...
    'data': [
        ...
        'views/pos_corte_caja_views.xml',
    ],
    ...
    'assets': {
        ...
        [   
            ...
            'pos_saveguard_tips/static/src/js/ChromeWidgets/MenuButtonCut.js',
            ...
            'pos_saveguard_tips/static/src/js/Popups/ShiftChangePopup.js',
            'pos_saveguard_tips/static/src/js/Popups/ReasingWaiterPopup.js',
            'pos_saveguard_tips/static/src/js/Popups/CashClosingPopup.js',

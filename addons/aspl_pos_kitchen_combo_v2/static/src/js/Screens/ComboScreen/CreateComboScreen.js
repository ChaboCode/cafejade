    ...
    class CreateComboScreen extends ControlButtonsMixin(PosComponent) {
        ...
        mounted() {
            if(this.state.mode == 'new'){
                ...
                //console.log("Esto es var orderline")
                ...
                //console.log("Esto es var combolines")
        ...
        async _addRequiredCombolines(product){
            ...
            for(var i = 0; i < requireLine.length; i++){
                ...
                for(var j = 0; j < productIds.length; j++){
                    ...
                    //console.log("Aqui +++++++++++++++++++++.........---------------------------")
                    //console.log(comboProduct['id'])
                    //console.log(requireLine[i][0])
                    var product_related = comboProduct['id']
                    var registry_related = requireLine[i][0]
                    const price_extra = await this.rpc({
                        model: 'pos.combo.line.line',
                        method: 'get_price_product',
                        args: [0, product_related,registry_related],
                    });
                    this.extraPriceProduct = price_extra
                    ...
                    this.quantityNewProduct = quantity_new
                    ...
                    order.add_combo_product(comboProduct, {
                        ...
                        'max': requireLine[i][3],
                        'extraPriceProduct':price_extra,
                        'quantityNewProduct':quantity_new,
                    });
                }
            }
        ...
        _addSavedCombolines(combolines){
            ...
            for(var i = 0; i < combolines_len; i++){
                ...
                this.currentOrder.add_combo_product(line.product, {
                    ...
                    'extraPriceProduct': line.extraPriceProduct,
                    'quantityNewProduct': line.quantityNewProduct,
        ...
        _addSplitComboline(comboline, qty, replaced){
            this.currentOrder.add_combo_product(comboline.product, {
                    ...
                    'extraPriceProduct': comboline.extraPriceProduct,
                    'quantityNewProduct': comboline.quantityNewProduct,
                });
        }
...
//            this.currentOrder.set_send_to_kitchen(false);
        ...
        _selectCategory(event){
            //console.log("Este es el valor que asigna en el evento de categoria")
            this.productWidget.comp.state.selectedComboCategoryId = event.detail.comboline.categoryId;
            //console.log(this.productWidget.comp.state.selectedComboCategoryId)
        }
        async _onClickBack(){
            if(this.state.editFlag == true){
                const { confirmed: confirmedPopup } = await this.showPopup('ConfirmPopup', {
        ...
        async _addProduct(event) {
            //console.log("Ingresa en _addProduct oasdjsakjdñosk ++++++++++++++++++++++++++++")
            ...
            const extraPriceProduct = event.detail.extraPriceProduct
            const quantityNewProduct = event.detail.quantityNew
            ...
            this.currentOrder.add_combo_product(product,{
                ...
                'basePrice': basePrice,
                'extraPriceProduct':extraPriceProduct,
                'quantityNewProduct':quantityNewProduct,
            });
            //console.log("Esto es this.currentLine")
            //console.log(this)
            //var product_related = this.currentLine.p_id
            //var registry_related = this.currentLine.categoryId
            ...
            //this.currentLine.extraPriceProduct = price_extra
            //this.currentLine.quantityNewProduct = quantity_new
            //this.topRef.comp._updateSummary()
            this._changeButtonEnable();
            //this._onClickSave();
            //this._onClickSave()
